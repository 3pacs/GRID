/**
 * Shared design tokens and styles for GRID PWA — TypeScript version.
 *
 * Re-exports everything from shared.js with type annotations.
 * New .tsx code should import from here; existing .jsx keeps using shared.js.
 */

import type { ThemeColors, ConfidenceColors } from '../types/index';
 ...
 */
export function getColors(themeName: string): ThemeColors {
    return themes[themeName] || themes.dark;
}

/** Read persisted theme or fall back to 'dark' */
function _savedTheme(): string {
...
export const colors: ThemeColors = getColors(_savedTheme());
...
export const shared = {
    ...
    badge: (color: string) => ({
        ...
        minWidth: '32px', justifyContent: 'center', whiteSpace: 'nowrap' as const,
    }),
    button: {
    ...
    input: {
        ...
        fontFamily: colors.mono, width: '100%', boxSizing: 'border-box' as const,
    ...
    prose: {
        ...
        whiteSpace: 'pre-wrap' as const, maxHeight: '500px', overflowY: 'auto' as const,
    ...
    metric: {
        background: colors.bg, borderRadius: tokens.radius.md,
        padding: tokens.space.md, textAlign: 'center' as const,
    },
    metricValue: {
    ...
    tabs: {
        ...
        overflowX: 'auto' as const, WebkitOverflowScrolling: 'touch',
    ...
    tab: (active: boolean) => ({
        ...
        minHeight: tokens.minTouch, whiteSpace: 'nowrap' as const,
        transition: `all ${tokens.transition.fast}`,
...
export const mobileOverrides = {
    ...
    noHorizontalScroll: { overflowX: 'hidden' as const },
} as const;

// ── Confidence level colors ──────────────────────────────────

export const confidence: ConfidenceColors = {
