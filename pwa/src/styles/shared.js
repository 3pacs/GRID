...
export const shared = {
    ...
    card: {
        ...
        marginBottom: tokens.space.md, boxShadow: colors.shadow.sm,
    },
    cardGradient: {
        background: colors.gradientCard, border: `1px solid ${colors.border}`,
        borderRadius: tokens.radius.lg, padding: tokens.space.xl,
        marginBottom: tokens.space.md, boxShadow: colors.shadow.md,
    },
    glassCard: {
    ...
    sectionTitle: {
        fontSize: tokens.fontSize.lg, fontWeight: 600, color: colors.textDim,
