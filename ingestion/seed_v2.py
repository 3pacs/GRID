...
VALUES
  ...
  -- Fed liquidity equation components
  ('overnight_reverse_repo',        'liquidity', 'Fed ON RRP facility daily usage (billions)',
   'FRED RRPONTSYD', 1, 0, 'RAW', 'FORWARD_FILL', '2013-09-23', TRUE),
  ('fed_treasury_holdings',         'liquidity', 'Fed holdings of Treasury securities (weekly)',
   'FRED WSHOSHO', 1, 0, 'RAW', 'FORWARD_FILL', '2002-12-18', TRUE),
  ('central_bank_liq_swaps',        'liquidity', 'Central bank liquidity swaps outstanding',
   'FRED SWPT', 1, 0, 'RAW', 'FORWARD_FILL', '2002-12-18', TRUE),
  ('bank_reserves_at_fed',          'liquidity', 'Bank reserves at Federal Reserve Banks',
   'FRED H8B1023NCBCMG', 1, 0, 'RAW', 'FORWARD_FILL', '1973-01-03', TRUE),
  ('total_reserves',                'liquidity', 'Total reserves of depository institutions (monthly)',
   'FRED TOTRESNS', 1, 0, 'RAW', 'FORWARD_FILL', '1959-01-01', TRUE),
  ('fed_net_liquidity',             'liquidity', 'Net liquidity = Fed BS - TGA - RRP (THE macro signal)',
   'COMPUTED: WALCL - WTREGEN - RRPONTSYD', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2013-09-23', TRUE),
  ('fed_net_liquidity_change_1w',   'liquidity', 'Week-over-week change in net liquidity',
   'COMPUTED: 7-day delta of fed_net_liquidity', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2013-10-01', TRUE),
  ('fed_net_liquidity_change_1m',   'liquidity', 'Month-over-month change in net liquidity',
   'COMPUTED: 30-day delta of fed_net_liquidity', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2013-11-01', TRUE),
  ('reverse_repo_pct_of_peak',      'liquidity', 'Current RRP as pct of historical peak (drain gauge)',
   'COMPUTED: RRPONTSYD / max(RRPONTSYD)', 1, 0, 'RAW', 'FORWARD_FILL', '2013-09-23', TRUE),
  ('tga_drawdown',                  'liquidity', '30-day TGA change (neg = Treasury spending = liq injection)',
   'COMPUTED: 30-day delta of WTREGEN', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2013-10-01', TRUE),

  -- ETF flow proxies
  ('etf_flow_spy_5d',   'flows', 'SPY 5-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 5d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2000-01-01', TRUE),
  ('etf_flow_spy_20d',  'flows', 'SPY 20-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 20d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2000-01-01', TRUE),
  ('etf_flow_spy_accel','flows', 'SPY flow acceleration (5d change of 5d flow)',
   'diff(5d) of ETF 5d rolling flow', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2000-01-01', TRUE),
  ('etf_flow_qqq_5d',   'flows', 'QQQ 5-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 5d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2000-01-01', TRUE),
  ('etf_flow_qqq_20d',  'flows', 'QQQ 20-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 20d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2000-01-01', TRUE),
  ('etf_flow_qqq_accel','flows', 'QQQ flow acceleration (5d change of 5d flow)',
   'diff(5d) of ETF 5d rolling flow', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2000-01-01', TRUE),
  ('etf_flow_iwm_5d',   'flows', 'IWM 5-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 5d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2000-01-01', TRUE),
  ('etf_flow_iwm_20d',  'flows', 'IWM 20-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 20d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2000-01-01', TRUE),
  ('etf_flow_iwm_accel','flows', 'IWM flow acceleration (5d change of 5d flow)',
   'diff(5d) of ETF 5d rolling flow', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2000-01-01', TRUE),
  ('etf_flow_tlt_5d',   'flows', 'TLT 5-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 5d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2002-07-01', TRUE),
  ('etf_flow_tlt_20d',  'flows', 'TLT 20-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 20d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2002-07-01', TRUE),
  ('etf_flow_tlt_accel','flows', 'TLT flow acceleration (5d change of 5d flow)',
   'diff(5d) of ETF 5d rolling flow', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2002-07-01', TRUE),
  ('etf_flow_hyg_5d',   'flows', 'HYG 5-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 5d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2007-04-01', TRUE),
  ('etf_flow_hyg_20d',  'flows', 'HYG 20-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 20d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2007-04-01', TRUE),
  ('etf_flow_hyg_accel','flows', 'HYG flow acceleration (5d change of 5d flow)',
   'diff(5d) of ETF 5d rolling flow', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2007-04-01', TRUE),
  ('etf_flow_gld_5d',   'flows', 'GLD 5-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 5d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2004-11-01', TRUE),
  ('etf_flow_gld_20d',  'flows', 'GLD 20-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 20d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2004-11-01', TRUE),
  ('etf_flow_gld_accel','flows', 'GLD flow acceleration (5d change of 5d flow)',
   'diff(5d) of ETF 5d rolling flow', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2004-11-01', TRUE),
  ('etf_flow_eem_5d',   'flows', 'EEM 5-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 5d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2003-04-01', TRUE),
  ('etf_flow_eem_20d',  'flows', 'EEM 20-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 20d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2003-04-01', TRUE),
  ('etf_flow_eem_accel','flows', 'EEM flow acceleration (5d change of 5d flow)',
   'diff(5d) of ETF 5d rolling flow', 1, 0, 'ZSCORE', 'FORWARD_FILL', '2003-04-01', TRUE),
  ('etf_flow_xlk_5d',   'flows', 'XLK 5-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 5d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '1998-12-01', TRUE),
  ('etf_flow_xlk_20d',  'flows', 'XLK 20-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 20d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '1998-12-01', TRUE),
  ('etf_flow_xlk_accel','flows', 'XLK flow acceleration (5d change of 5d flow)',
   'diff(5d) of ETF 5d rolling flow', 1, 0, 'ZSCORE', 'FORWARD_FILL', '1998-12-01', TRUE),
  ('etf_flow_xlf_5d',   'flows', 'XLF 5-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 5d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '1998-12-01', TRUE),
  ('etf_flow_xlf_20d',  'flows', 'XLF 20-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 20d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '1998-12-01', TRUE),
  ('etf_flow_xlf_accel','flows', 'XLF flow acceleration (5d change of 5d flow)',
   'diff(5d) of ETF 5d rolling flow', 1, 0, 'ZSCORE', 'FORWARD_FILL', '1998-12-01', TRUE),
  ('etf_flow_xle_5d',   'flows', 'XLE 5-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 5d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '1998-12-01', TRUE),
  ('etf_flow_xle_20d',  'flows', 'XLE 20-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 20d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '1998-12-01', TRUE),
  ('etf_flow_xle_accel','flows', 'XLE flow acceleration (5d change of 5d flow)',
   'diff(5d) of ETF 5d rolling flow', 1, 0, 'ZSCORE', 'FORWARD_FILL', '1998-12-01', TRUE),
  ('etf_flow_xlv_5d',   'flows', 'XLV 5-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 5d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '1998-12-01', TRUE),
  ('etf_flow_xlv_20d',  'flows', 'XLV 20-day rolling dollar volume flow proxy',
   'ETF daily close*volume rolling 20d sum', 1, 0, 'ZSCORE', 'FORWARD_FILL', '1998-12-01', TRUE),
  ('etf_flow_xlv_accel','flows', 'XLV flow acceleration (5d change of 5d flow)',
   'diff(5d) of ETF 5d rolling flow', 1, 0, 'ZSCORE', 'FORWARD_FILL', '1998-12-01', TRUE)
