...
class USDAPuller(BasePuller):
    """Pulls agricultural data from USDA NASS QuickStats API."""

    SOURCE_NAME = "USDA_NASS"
    SOURCE_CONFIG = {"base_url": "https://quickstats.nass.usda.gov/api", "cost_tier": "FREE", "latency_class": "MONTHLY", "pit_available": True, "revision_behavior": "RARE", "trust_score": "HIGH", "priority_rank": 18}
