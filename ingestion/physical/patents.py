...
class PatentsPuller(BasePuller):
    """Pulls patent velocity data from the USPTO PatentsView API."""

    SOURCE_NAME = "USPTO_PV"
    SOURCE_CONFIG = {"base_url": "https://search.patentsview.org/api/v1", "cost_tier": "FREE", "latency_class": "MONTHLY", "pit_available": False, "revision_behavior": "NEVER", "trust_score": "HIGH", "priority_rank": 40}
