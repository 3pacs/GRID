...
class WIODPuller(BasePuller):
    """Processes World Input-Output Tables for GVC participation analysis."""

    SOURCE_NAME = "WIOD"
    SOURCE_CONFIG = {"base_url": "https://www.wiod.org/database/wiots16", "cost_tier": "FREE", "latency_class": "MONTHLY", "pit_available": False, "revision_behavior": "NEVER", "trust_score": "HIGH", "priority_rank": 32}
