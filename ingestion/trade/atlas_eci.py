...
class AtlasECIPuller(BasePuller):
    """Pulls Economic Complexity Index scores from the Harvard Atlas."""

    SOURCE_NAME = "Atlas_ECI"
    SOURCE_CONFIG = {"base_url": "https://atlas.cid.harvard.edu", "cost_tier": "FREE", "latency_class": "MONTHLY", "pit_available": False, "revision_behavior": "RARE", "trust_score": "HIGH", "priority_rank": 34}
