...
Reference full template: `/home/user/17th/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/17th/.claude/get-shit-done/templates/state.md`.
