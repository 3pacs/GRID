...
<execution_context>
@/home/user/17th/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/home/user/17th/.claude/get-shit-done/workflows/manager.md end-to-end.
