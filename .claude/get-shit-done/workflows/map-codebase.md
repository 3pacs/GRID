...
```bash
INIT=$(node "/home/user/17th/.claude/get-shit-done/bin/gsd-tools.cjs" init map-codebase)
...
```bash
node "/home/user/17th/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: map existing codebase" --files .planning/codebase/*.md
```
