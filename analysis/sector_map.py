    ...
    "Commodities": {
        ...
        "subsectors": {
            "Precious Metals": {
                "weight": 0.25,
                "actors": [
                    {"name": "SPDR Gold Trust", "ticker": "GLD", "weight": 0.20, "type": "etf",
                     "description": "Largest gold ETF — direct gold price proxy",
                     "features": ["gold", "gold_full"]},
                    {"name": "Newmont", "ticker": "NEM", "weight": 0.15, "type": "company",
                     "description": "World's largest gold miner — gold price leverage",
                     "features": ["nem", "nem_full"]},
                    {"name": "Barrick Gold", "ticker": "GOLD", "weight": 0.12, "type": "company",
                     "description": "Major gold/copper miner — Nevada/Africa exposure",
                     "features": ["gold_full"]},
                    {"name": "Agnico Eagle", "ticker": "AEM", "weight": 0.08, "type": "company",
                     "description": "Premium gold miner — Canadian/Australian operations",
                     "features": ["aem", "aem_full"]},
                    {"name": "iShares Silver Trust", "ticker": "SLV", "weight": 0.10, "type": "etf",
                     "description": "Silver price proxy — industrial + monetary metal",
                     "features": ["silver"]},
                    {"name": "Central Bank Buying", "ticker": None, "weight": 0.20, "type": "sovereign",
                     "description": "China/India/Turkey CBs accumulating gold — structural bid",
                     "features": ["gold", "gold_full"]},
                    {"name": "Real Rates", "ticker": None, "weight": 0.15, "type": "macro",
            ...
            "Industrial Metals": {
                "weight": 0.25,
                "actors": [
                    {"name": "Freeport-McMoRan", "ticker": "FCX", "weight": 0.20, "type": "company",
                     "description": "World's largest publicly traded copper producer — Grasberg mine",
                     "features": ["fcx", "fcx_full", "copper"]},
                    {"name": "Southern Copper", "ticker": "SCCO", "weight": 0.12, "type": "company",
                     "description": "Copper/zinc producer — Peru/Mexico operations",
                     "features": ["scco", "scco_full"]},
                    {"name": "BHP Group", "ticker": "BHP", "weight": 0.15, "type": "company",
                     "description": "World's largest miner — copper, iron ore, coal",
                     "features": ["bhp", "bhp_full"]},
                    {"name": "Rio Tinto", "ticker": "RIO", "weight": 0.12, "type": "company",
                     "description": "Iron ore, aluminum, copper — Pilbara operations",
                     "features": ["rio", "rio_full"]},
                    {"name": "China Construction", "ticker": None, "weight": 0.20, "type": "macro",
                     "description": "China property sector drives >50% of copper demand",
                     "features": ["copper", "china_pmi_mfg"]},
                    {"name": "EV Transition", "ticker": None, "weight": 0.10, "type": "structural",
            ...
            "Energy Commodities": {
                "weight": 0.25,
                "actors": [
                    {"name": "US Oil Fund", "ticker": "USO", "weight": 0.18, "type": "etf",
                     "description": "Crude oil price proxy — WTI front-month tracker",
                     "features": ["crude_oil", "wti"]},
                    {"name": "US Natural Gas Fund", "ticker": "UNG", "weight": 0.12, "type": "etf",
                     "description": "Natural gas price proxy — Henry Hub tracker",
                     "features": ["natural_gas"]},
                    {"name": "Invesco DB Agriculture", "ticker": "DBA", "weight": 0.10, "type": "etf",
                     "description": "Agricultural commodity basket — corn, soy, wheat, sugar, cocoa",
                     "features": ["wheat", "corn"]},
                    {"name": "OPEC Policy", "ticker": None, "weight": 0.30, "type": "sovereign",
                     "description": "OPEC+ production cuts/increases — supply valve for oil",
                     "features": ["crude_oil", "wti"]},
                    {"name": "US Shale", "ticker": None, "weight": 0.15, "type": "structural",
                     "description": "Permian Basin production — marginal barrel swing producer",
                     "features": ["crude_oil", "wti"]},
                ],
            },
            "Agriculture & Soft Commodities": {
                "weight": 0.25,
                "actors": [
                    {"name": "Archer-Daniels-Midland", "ticker": "ADM", "weight": 0.18, "type": "company",
                     "description": "Grain processing giant — agricultural cycle bellwether",
                     "features": ["adm", "adm_full"]},
                    {"name": "Bunge Global", "ticker": "BG", "weight": 0.12, "type": "company",
                     "description": "Oilseed/grain processing — food supply chain infrastructure",
                     "features": ["bg", "bg_full"]},
                    {"name": "Nutrien", "ticker": "NTR", "weight": 0.15, "type": "company",
                     "description": "World's largest fertilizer producer — crop input cost driver",
                     "features": ["ntr", "ntr_full"]},
                    {"name": "Mosaic", "ticker": "MOS", "weight": 0.10, "type": "company",
                     "description": "Phosphate & potash producer — fertilizer price proxy",
                     "features": ["mos", "mos_full"]},
                    {"name": "Deere & Company", "ticker": "DE", "weight": 0.15, "type": "company",
                     "description": "Farm equipment — agricultural capex cycle indicator",
                     "features": ["de", "de_full"]},
                ],
            },
        },
    ...
    "Crypto": {
        ...
        "subsectors": {
            "Bitcoin": {
                "weight": 0.40,
                "actors": [
                    {"name": "Bitcoin", "ticker": "BTC-USD", "weight": 0.30, "type": "asset",
                     "description": "Digital gold — store of value, institutional adoption accelerating",
                     "features": ["btc", "btc_full"]},
                    {"name": "iShares Bitcoin Trust", "ticker": "IBIT", "weight": 0.20, "type": "etf",
                     "description": "BlackRock spot BTC ETF — institutional flow channel",
                     "features": ["btc", "btc_full"]},
                    {"name": "MicroStrategy", "ticker": "MSTR", "weight": 0.12, "type": "company",
                     "description": "Largest corporate BTC holder — leveraged bitcoin proxy",
                     "features": ["mstr", "mstr_full"]},
                    {"name": "Crypto Fear/Greed", "ticker": None, "weight": 0.10, "type": "sentiment",
                     "description": "Retail sentiment oscillator",
                     "features": ["crypto_fear_greed"]},
                    {"name": "Fed Liquidity", "ticker": None, "weight": 0.15, "type": "macro",
            ...
            "DeFi / Altcoins": {
                "weight": 0.30,
                "actors": [
                    {"name": "Ethereum", "ticker": "ETH-USD", "weight": 0.35, "type": "asset",
                     "description": "Smart contract platform — DeFi/NFT infrastructure layer",
                     "features": ["eth", "eth_full"]},
                    {"name": "Solana", "ticker": "SOL-USD", "weight": 0.25, "type": "asset",
                     "description": "High-throughput L1 — DeFi/meme coin ecosystem",
                     "features": ["sol"]},
                    {"name": "BTC Dominance", "ticker": None, "weight": 0.15, "type": "indicator",
            ...
            "Crypto Infrastructure": {
                "weight": 0.30,
                "actors": [
                    {"name": "Coinbase", "ticker": "COIN", "weight": 0.30, "type": "company",
                     "description": "Largest US crypto exchange — retail/institutional volume proxy",
                     "features": ["coin", "coin_full"]},
                    {"name": "Marathon Digital", "ticker": "MARA", "weight": 0.15, "type": "company",
                     "description": "Largest US bitcoin miner — hashrate and energy cost proxy",
                     "features": ["mara", "mara_full"]},
                    {"name": "Riot Platforms", "ticker": "RIOT", "weight": 0.12, "type": "company",
                     "description": "Bitcoin miner — Rockdale TX facility, energy arbitrage",
                     "features": ["riot", "riot_full"]},
                    {"name": "Block Inc", "ticker": "XYZ", "weight": 0.10, "type": "company",
                     "description": "Cash App bitcoin + Lightning Network — retail onramp",
                     "features": ["xyz", "xyz_full"]},
                ],
            },
        },
