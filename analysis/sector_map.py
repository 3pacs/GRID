    ...
    "Technology": {
        ...
        "subsectors": {
            "Semiconductors": {
                "weight": 0.30,
                "actors": [
                    {"name": "NVIDIA", "ticker": "NVDA", "weight": 0.25, "type": "company",
                     "description": "AI chip monopoly — sets the capex cycle for hyperscalers",
                     "features": ["nvda", "nvda_full"]},
                    {"name": "Broadcom", "ticker": "AVGO", "weight": 0.13, "type": "company",
                     "description": "Custom AI silicon + networking — VMware integration",
                     "features": ["avgo", "avgo_full"]},
                    {"name": "TSMC", "ticker": "TSM", "weight": 0.12, "type": "company",
                     "description": "Fabrication bottleneck — all advanced chips flow through here",
                     "features": ["tsm", "tsm_full"]},
                    {"name": "AMD", "ticker": "AMD", "weight": 0.08, "type": "company",
                     "description": "GPU/CPU competitor — MI300 AI accelerator challenger",
                     "features": ["amd", "amd_full"]},
                    {"name": "ASML", "ticker": "ASML", "weight": 0.08, "type": "company",
                     "description": "EUV lithography monopoly — gatekeeper for advanced node fabs",
                     "features": ["asml", "asml_full"]},
                    {"name": "Qualcomm", "ticker": "QCOM", "weight": 0.06, "type": "company",
                     "description": "Mobile/auto chip + AI edge inference — Snapdragon platform",
                     "features": ["qcom", "qcom_full"]},
                    {"name": "Texas Instruments", "ticker": "TXN", "weight": 0.05, "type": "company",
                     "description": "Analog/embedded chips — industrial cycle bellwether",
                     "features": ["txn", "txn_full"]},
                    {"name": "Intel", "ticker": "INTC", "weight": 0.05, "type": "company",
                     "description": "US fab champion — CHIPS Act beneficiary",
                     "features": ["intc", "intc_full"]},
                    {"name": "US CHIPS Act", "ticker": None, "weight": 0.10, "type": "policy",
                     "description": "$52B subsidy reshaping global fab investment",
                     "features": ["wiki_ai", "smh"]},
                    {"name": "China Export Controls", "ticker": None, "weight": 0.08, "type": "policy",
            ...
            "Cloud & AI Platforms": {
                "weight": 0.35,
                "actors": [
                    {"name": "Microsoft", "ticker": "MSFT", "weight": 0.22, "type": "company",
                     "description": "Azure + OpenAI integration — enterprise AI gatekeeper",
                     "features": ["msft", "msft_full"]},
                    {"name": "Amazon", "ticker": "AMZN", "weight": 0.18, "type": "company",
                     "description": "AWS dominates cloud infra spend",
                     "features": ["amzn", "amzn_full"]},
                    {"name": "Alphabet", "ticker": "GOOGL", "weight": 0.18, "type": "company",
                    ...
                    {"name": "Oracle", "ticker": "ORCL", "weight": 0.07, "type": "company",
                     "description": "Cloud infra + database — enterprise AI/data platform",
                     "features": ["orcl", "orcl_full"]},
                    {"name": "Snowflake", "ticker": "SNOW", "weight": 0.05, "type": "company",
                     "description": "Cloud data warehouse — enterprise data spend proxy",
                     "features": ["snow", "snow_full"]},
                ],
            },
            "Enterprise Software": {
                "weight": 0.10,
                "actors": [
                    {"name": "Salesforce", "ticker": "CRM", "weight": 0.30, "type": "company",
                     "description": "Enterprise SaaS bellwether — AI agent platform",
                     "features": ["crm", "crm_full"]},
                    {"name": "ServiceNow", "ticker": "NOW", "weight": 0.25, "type": "company",
                     "description": "IT workflow automation — enterprise AI workflows",
                     "features": ["now", "now_full"]},
                    {"name": "Adobe", "ticker": "ADBE", "weight": 0.20, "type": "company",
                     "description": "Creative + document cloud — AI content generation play",
                     "features": ["adbe", "adbe_full"]},
                    {"name": "Palantir", "ticker": "PLTR", "weight": 0.15, "type": "company",
                     "description": "AI/data analytics platform — government + enterprise",
                     "features": ["pltr", "pltr_full"]},
                ],
            },
            "Consumer Hardware": {
                "weight": 0.15,
                "actors": [
                    {"name": "Apple", "ticker": "AAPL", "weight": 0.55, "type": "company",
                     "description": "Consumer hardware + services — China demand proxy",
                     "features": ["aapl", "aapl_full"]},
                    {"name": "Tesla", "ticker": "TSLA", "weight": 0.30, "type": "company",
                     "description": "EV + energy + AI autonomy — retail sentiment bellwether",
            ...
            "Cybersecurity": {
                "weight": 0.10,
                "actors": [
                    {"name": "CrowdStrike", "ticker": "CRWD", "weight": 0.35, "type": "company",
                     "description": "Endpoint security leader — platform consolidation play",
                     "features": ["crwd", "crwd_full"]},
                    {"name": "Palo Alto Networks", "ticker": "PANW", "weight": 0.30, "type": "company",
                     "description": "Network security + SASE — largest cybersecurity company",
                     "features": ["panw", "panw_full"]},
                    {"name": "Fortinet", "ticker": "FTNT", "weight": 0.15, "type": "company",
                     "description": "Firewall/SD-WAN — cyber defense infrastructure",
                     "features": ["ftnt", "ftnt_full"]},
                ],
            },
        },
    },
    "Energy": {
        ...
        "subsectors": {
            "Crude Oil": {
                "weight": 0.30,
                "actors": [
                    {"name": "Saudi Arabia / OPEC+", "ticker": None, "weight": 0.25, "type": "sovereign",
                     "description": "Controls ~40% of global oil supply — production cuts move price",
                     "features": ["crude_oil", "wti_crude"]},
                    {"name": "ExxonMobil", "ticker": "XOM", "weight": 0.18, "type": "company",
                     "description": "Largest US oil major — upstream/downstream bellwether",
                     "features": ["xom", "xom_full"]},
                    {"name": "Chevron", "ticker": "CVX", "weight": 0.15, "type": "company",
                     "description": "Second-largest US major — Permian Basin + Hess merger",
                     "features": ["cvx", "cvx_full"]},
                    {"name": "China Demand", "ticker": None, "weight": 0.12, "type": "macro",
                     "description": "Largest incremental oil importer — PMI drives demand forecasts",
                     "features": ["china_pmi_mfg"]},
                    {"name": "US Strategic Reserve", "ticker": None, "weight": 0.08, "type": "policy",
                     "description": "SPR draws/fills move short-term supply balance",
                     "features": ["crude_oil", "wti_crude"]},
                    {"name": "EIA Inventories", "ticker": None, "weight": 0.08, "type": "data",
            ...
            "E&P": {
                "weight": 0.25,
                "actors": [
                    {"name": "ConocoPhillips", "ticker": "COP", "weight": 0.25, "type": "company",
                     "description": "Largest US pure-play E&P — Permian + Alaska + international",
                     "features": ["cop", "cop_full"]},
                    {"name": "EOG Resources", "ticker": "EOG", "weight": 0.18, "type": "company",
                     "description": "Premium shale operator — Permian + Eagle Ford swing producer",
                     "features": ["eog", "eog_full"]},
                    {"name": "Occidental Petroleum", "ticker": "OXY", "weight": 0.15, "type": "company",
                     "description": "Buffett-backed — Permian Basin + carbon capture play",
                     "features": ["oxy", "oxy_full"]},
                    {"name": "Devon Energy", "ticker": "DVN", "weight": 0.12, "type": "company",
                     "description": "Variable dividend model — production growth proxy",
                     "features": ["dvn", "dvn_full"]},
                    {"name": "Diamondback Energy", "ticker": "FANG", "weight": 0.10, "type": "company",
                     "description": "Pure-play Permian Basin — low-cost operator",
                     "features": ["fang", "fang_full"]},
                    {"name": "E&P Sentiment (XOP)", "ticker": "XOP", "weight": 0.10, "type": "indicator",
                     "description": "Equal-weight E&P ETF — breadth gauge for producers",
                     "features": ["xop"]},
                ],
            },
            "Oilfield Services": {
                "weight": 0.10,
                "actors": [
                    {"name": "Schlumberger", "ticker": "SLB", "weight": 0.40, "type": "company",
                     "description": "Largest oilfield services — global rig count proxy",
                     "features": ["slb", "slb_full"]},
                    {"name": "Halliburton", "ticker": "HAL", "weight": 0.30, "type": "company",
                     "description": "North America completions leader — shale activity gauge",
                     "features": ["hal", "hal_full"]},
                    {"name": "Baker Hughes", "ticker": "BKR", "weight": 0.20, "type": "company",
                     "description": "LNG equipment + oilfield tech — energy transition play",
                     "features": ["bkr", "bkr_full"]},
                ],
            },
            "Natural Gas": {
                "weight": 0.10,
                "actors": [
                    {"name": "Cheniere Energy", "ticker": "LNG", "weight": 0.30, "type": "company",
                     "description": "Largest US LNG exporter — sets floor on domestic gas prices",
                     "features": ["lng", "lng_full"]},
                    {"name": "LNG Export Capacity", "ticker": None, "weight": 0.25, "type": "infra",
                     "description": "US LNG terminals expanding — structural demand support",
                     "features": ["eia_natgas_henry_hub"]},
                    {"name": "Weather (HDD/CDD)", "ticker": None, "weight": 0.20, "type": "physical",
                     "description": "Heating/cooling demand drives seasonal swings",
                     "features": ["weather_nyc_temp", "weather_london_temp"]},
                    {"name": "EQT Corporation", "ticker": "EQT", "weight": 0.15, "type": "company",
                     "description": "Largest US natural gas producer — Appalachian Basin",
                     "features": ["eqt", "eqt_full"]},
                ],
            },
            "Refining & Midstream": {
                "weight": 0.15,
                "actors": [
                    {"name": "Marathon Petroleum", "ticker": "MPC", "weight": 0.25, "type": "company",
                     "description": "Largest US refiner — crack spread proxy",
                     "features": ["mpc", "mpc_full"]},
                    {"name": "Valero Energy", "ticker": "VLO", "weight": 0.20, "type": "company",
                     "description": "Refining + renewable diesel — crude-to-product margins",
                     "features": ["vlo", "vlo_full"]},
                    {"name": "Williams Companies", "ticker": "WMB", "weight": 0.15, "type": "company",
                     "description": "Natural gas pipelines — stable midstream infrastructure",
                     "features": ["wmb", "wmb_full"]},
                    {"name": "Phillips 66", "ticker": "PSX", "weight": 0.15, "type": "company",
                     "description": "Diversified refiner + midstream + chemicals",
                     "features": ["psx", "psx_full"]},
                ],
            },
            "Renewables": {
                "weight": 0.10,
                "actors": [
                    {"name": "NextEra Energy", "ticker": "NEE", "weight": 0.30, "type": "company",
                     "description": "Largest renewable energy operator — wind + solar + utility",
                     "features": ["nee", "nee_full"]},
                    {"name": "First Solar", "ticker": "FSLR", "weight": 0.20, "type": "company",
                     "description": "US solar panel manufacturer — IRA beneficiary",
                     "features": ["fslr", "fslr_full"]},
                    {"name": "IRA Subsidies", "ticker": None, "weight": 0.25, "type": "policy",
                     "description": "Inflation Reduction Act — $369B in clean energy tax credits",
                     "features": ["icln", "patent_velocity_cleanenergy"]},
                    {"name": "Enphase Energy", "ticker": "ENPH", "weight": 0.15, "type": "company",
                     "description": "Microinverter leader — residential solar infrastructure",
                     "features": ["enph", "enph_full"]},
                ],
            },
        },
    },
    "Financials": {
        ...
        "subsectors": {
            "Banks": {
                "weight": 0.35,
                "actors": [
                    {"name": "Federal Reserve", "ticker": None, "weight": 0.20, "type": "central_bank",
                    ...
                    {"name": "JPMorgan Chase", "ticker": "JPM", "weight": 0.18, "type": "company",
                     "description": "Largest US bank — loan growth proxy",
                     "features": ["jpm", "jpm_full", "loan_growth"]},
                    {"name": "Bank of America", "ticker": "BAC", "weight": 0.12, "type": "company",
                    ...
                    {"name": "Goldman Sachs", "ticker": "GS", "weight": 0.10, "type": "company",
                     ...
                     "features": ["gs", "gs_full"]},
                    {"name": "Morgan Stanley", "ticker": "MS", "weight": 0.08, "type": "company",
                     "description": "Wealth management + IB — fee-based revenue model",
                     "features": ["ms", "ms_full"]},
                    {"name": "Wells Fargo", "ticker": "WFC", "weight": 0.08, "type": "company",
                     "description": "Consumer/commercial banking — mortgage origination proxy",
                     "features": ["wfc", "wfc_full"]},
                    {"name": "Citigroup", "ticker": "C", "weight": 0.06, "type": "company",
                     "description": "Global banking — EM exposure + restructuring play",
                     "features": ["c", "c_full"]},
                    {"name": "FDIC / OCC", "ticker": None, "weight": 0.06, "type": "regulator",
                     "description": "Bank failure resolution, capital rules",
                     "features": ["loan_growth", "ted_spread"]},
                    {"name": "Regional Banks (KRE)", "ticker": "KRE", "weight": 0.12, "type": "subsector",
            ...
            "Asset Management": {
                "weight": 0.20,
                "actors": [
                    {"name": "BlackRock", "ticker": "BLK", "weight": 0.25, "type": "company",
                     "description": "$10T AUM — passive flow + ETF dominance",
                     "features": ["blk", "blk_full"]},
                    {"name": "Berkshire Hathaway", "ticker": "BRK-B", "weight": 0.25, "type": "company",
                     "description": "Insurance + conglomerate — Buffett indicator",
                     "features": ["brk_b", "brk_b_full"]},
                    {"name": "Charles Schwab", "ticker": "SCHW", "weight": 0.15, "type": "company",
                     "description": "Largest US brokerage — retail trading activity proxy",
                     "features": ["schw", "schw_full"]},
                    {"name": "S&P Global", "ticker": "SPGI", "weight": 0.12, "type": "company",
                     "description": "Credit ratings + data analytics — bond issuance proxy",
                     "features": ["spgi", "spgi_full"]},
                    {"name": "KKR", "ticker": "KKR", "weight": 0.10, "type": "company",
                     "description": "Private equity + alt credit — alternative assets growth",
            ...
            "Fintech & Payments": {
                "weight": 0.15,
                "actors": [
                    {"name": "Visa", "ticker": "V", "weight": 0.30, "type": "company",
                     "description": "Global payment network — consumer spending real-time proxy",
                     "features": ["v", "v_full"]},
                    {"name": "Mastercard", "ticker": "MA", "weight": 0.25, "type": "company",
                     "description": "Payment network — cross-border transaction volumes",
                     "features": ["ma", "ma_full"]},
            ...
            "Insurance": {
                "weight": 0.10,
                "actors": [
                    {"name": "Bond Yields", "ticker": None, "weight": 0.30, "type": "macro",
                     "description": "Insurance float returns track long-end yields",
                     "features": ["treasury_30y", "breakeven_10y"]},
                    {"name": "Progressive", "ticker": "PGR", "weight": 0.25, "type": "company",
                     "description": "Auto insurance leader — P&C underwriting cycle proxy",
                     "features": ["pgr", "pgr_full"]},
                    {"name": "Marsh McLennan", "ticker": "MMC", "weight": 0.20, "type": "company",
                     "description": "Insurance brokerage — commercial insurance pricing proxy",
                     "features": ["mmc", "mmc_full"]},
                ],
            },
            "Credit Markets": {
                "weight": 0.20,
                "actors": [
                    {"name": "HY Spread", "ticker": None, "weight": 0.30, "type": "indicator",
    ...
    "Healthcare": {
        ...
        "subsectors": {
            "Pharma": {
                "weight": 0.25,
                "actors": [
                    {"name": "Johnson & Johnson", "ticker": "JNJ", "weight": 0.18, "type": "company",
                     "description": "Pharma + MedTech diversified — defensive healthcare name",
                     "features": ["jnj", "jnj_full"]},
                    {"name": "Merck", "ticker": "MRK", "weight": 0.15, "type": "company",
                     "description": "Keytruda franchise — oncology leadership",
                     "features": ["mrk", "mrk_full"]},
                    {"name": "AbbVie", "ticker": "ABBV", "weight": 0.15, "type": "company",
                     "description": "Humira LOE + Skyrizi/Rinvoq growth — immunology pivot",
                     "features": ["abbv", "abbv_full"]},
                    {"name": "Pfizer", "ticker": "PFE", "weight": 0.10, "type": "company",
                     "description": "Vaccine + oncology pipeline — post-COVID revenue normalization",
                     "features": ["pfe", "pfe_full"]},
                    {"name": "Bristol-Myers Squibb", "ticker": "BMY", "weight": 0.08, "type": "company",
                     "description": "Oncology + cardiovascular — Opdivo/Eliquis franchise",
                     "features": ["bmy", "bmy_full"]},
                    {"name": "FDA Approvals", "ticker": None, "weight": 0.12, "type": "regulator",
                     "description": "Drug approvals and recalls — binary catalysts",
                     "features": ["fda_adverse_events"]},
                    {"name": "IRA Drug Pricing", "ticker": None, "weight": 0.10, "type": "policy",
                     "description": "Medicare negotiation compresses pharma margins",
                     "features": ["xlv", "xbi"]},
                    {"name": "AstraZeneca", "ticker": "AZN", "weight": 0.07, "type": "company",
                     "description": "Oncology pipeline + vaccine franchise — UK-based global pharma",
                     "features": ["azn", "azn_full"]},
                    {"name": "Gilead Sciences", "ticker": "GILD", "weight": 0.05, "type": "company",
                     "description": "HIV/HCV franchise — antiviral specialist",
                     "features": ["gild", "gild_full"]},
                ],
            },
            "GLP-1 / Obesity": {
                "weight": 0.20,
                "actors": [
                    {"name": "Eli Lilly", "ticker": "LLY", "weight": 0.45, "type": "company",
                     "description": "GLP-1 leader (Mounjaro/Zepbound) — obesity market catalyst",
                     "features": ["lly", "lly_full"]},
                    {"name": "Novo Nordisk", "ticker": "NVO", "weight": 0.35, "type": "company",
                     "description": "Ozempic/Wegovy — original GLP-1 pioneer, $50B+ revenue",
                     "features": ["nvo", "nvo_full"]},
                    {"name": "Viking Therapeutics", "ticker": "VKTX", "weight": 0.10, "type": "company",
                     "description": "Oral GLP-1 challenger — Phase 3 catalysts could disrupt injectables",
                     "features": ["vktx", "vktx_full"]},
                    {"name": "Amgen", "ticker": "AMGN", "weight": 0.10, "type": "company",
                     "description": "MariTide oral obesity candidate — late-stage pipeline threat to incumbents",
                     "features": ["amgn", "amgn_full"]},
                ],
            },
            "Biotech": {
                "weight": 0.15,
                "actors": [
                    {"name": "Regeneron", "ticker": "REGN", "weight": 0.20, "type": "company",
                     "description": "Dupixent + Eylea + genetics platform — biotech heavyweight",
                     "features": ["regn", "regn_full"]},
                    {"name": "Vertex Pharmaceuticals", "ticker": "VRTX", "weight": 0.15, "type": "company",
                     "description": "CF franchise monopoly + pain pipeline — high-conviction biotech",
                     "features": ["vrtx", "vrtx_full"]},
                    {"name": "Moderna", "ticker": "MRNA", "weight": 0.12, "type": "company",
                     "description": "mRNA platform — cancer vaccine pipeline + RSV",
                     "features": ["mrna", "mrna_full"]},
                    {"name": "Biotech Sentiment (XBI)", "ticker": "XBI", "weight": 0.15, "type": "indicator",
                     "description": "Equal-weight biotech ETF — small-cap pipeline bets",
                     "features": ["xbi"]},
                    {"name": "CRISPR Therapeutics", "ticker": "CRSP", "weight": 0.08, "type": "company",
                     "description": "Gene editing — first approved CRISPR therapy (Casgevy)",
                     "features": ["crsp", "crsp_full"]},
                    {"name": "Illumina", "ticker": "ILMN", "weight": 0.08, "type": "company",
                     "description": "DNA sequencing monopoly — genomics infrastructure",
                     "features": ["ilmn", "ilmn_full"]},
                ],
            },
            "Medical Devices": {
                "weight": 0.20,
                "actors": [
                    {"name": "Intuitive Surgical", "ticker": "ISRG", "weight": 0.20, "type": "company",
                     "description": "da Vinci surgical robot monopoly — procedure volume proxy",
                     "features": ["isrg", "isrg_full"]},
                    {"name": "Abbott Laboratories", "ticker": "ABT", "weight": 0.18, "type": "company",
                     "description": "Diagnostics + medical devices + nutrition — diversified healthcare",
                     "features": ["abt", "abt_full"]},
                    {"name": "Stryker", "ticker": "SYK", "weight": 0.15, "type": "company",
                     "description": "Orthopedic implants + surgical equipment — hospital capex cycle",
                     "features": ["syk", "syk_full"]},
                    {"name": "Medtronic", "ticker": "MDT", "weight": 0.12, "type": "company",
                     "description": "Cardiac devices + spine + diabetes tech — largest pure-play devices",
                     "features": ["mdt", "mdt_full"]},
                    {"name": "Boston Scientific", "ticker": "BSX", "weight": 0.12, "type": "company",
                     "description": "Cardiovascular + rhythm management — procedure volume growth",
                     "features": ["bsx", "bsx_full"]},
                    {"name": "DexCom", "ticker": "DXCM", "weight": 0.08, "type": "company",
                     "description": "Continuous glucose monitor leader — diabetes tech growth",
                     "features": ["dxcm", "dxcm_full"]},
                    {"name": "Edwards Lifesciences", "ticker": "EW", "weight": 0.08, "type": "company",
                     "description": "TAVR heart valve monopoly — structural heart specialist",
                     "features": ["ew", "ew_full"]},
                ],
            },
            "Managed Care": {
                "weight": 0.15,
                "actors": [
                    {"name": "UnitedHealth", "ticker": "UNH", "weight": 0.35, "type": "company",
                     "description": "Largest health insurer + Optum — managed care bellwether",
                     "features": ["unh", "unh_full"]},
                    {"name": "Elevance Health", "ticker": "ELV", "weight": 0.15, "type": "company",
                     "description": "Blue Cross licensee — Medicaid + commercial insurance",
                     "features": ["elv", "elv_full"]},
                    {"name": "Cigna", "ticker": "CI", "weight": 0.12, "type": "company",
                     "description": "Health services + PBM (Express Scripts) — managed care margins",
                     "features": ["ci", "ci_full"]},
                    {"name": "HCA Healthcare", "ticker": "HCA", "weight": 0.10, "type": "company",
                     "description": "Largest for-profit hospital operator — admission volumes proxy",
                     "features": ["hca", "hca_full"]},
                    {"name": "CVS Health", "ticker": "CVS", "weight": 0.08, "type": "company",
                     "description": "Pharmacy + Aetna insurance + MinuteClinic — vertical integration",
                     "features": ["cvs", "cvs_full"]},
                ],
            },
            "Life Science Tools": {
                "weight": 0.05,
                "actors": [
                    {"name": "Thermo Fisher", "ticker": "TMO", "weight": 0.40, "type": "company",
                     "description": "Life science tools — biotech R&D spend proxy",
                     "features": ["tmo", "tmo_full"]},
                    {"name": "Danaher", "ticker": "DHR", "weight": 0.35, "type": "company",
                     "description": "Diagnostics + life sciences instruments — Danaher Business System",
                     "features": ["dhr", "dhr_full"]},
                ],
            },
        },
    },
