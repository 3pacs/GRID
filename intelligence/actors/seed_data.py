"""
GRID Intelligence — Actor Network seed data.

Contains the _KNOWN_ACTORS dictionary (500+ named players across tiers),
sector-committee mappings, and ticker-sector hints used for pocket-lining
detection.
