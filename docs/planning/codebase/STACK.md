...
- **Routing:** 12 routers under `/api/v1/` prefix:
  ...
  - `grid/api/routers/journal.py` — [[Decision Journal|decision journal]]
  - `grid/api/routers/models.py` — [[Model Governance|model governance]]
  - `grid/api/routers/discovery.py` — [[Regime Discovery|regime discovery]]
