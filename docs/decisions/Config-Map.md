...
`GEMINI_API_KEY`, `GRID_INTEL_KEY`, `GROQ_API_KEY`, `HERMES_EMAIL_ALLOWLIST`, `MASSIVE_API_KEY`, `PERPLEXITY_API_KEY`, `LLAMACPP_CTX`, `LLAMACPP_MODEL`, `LLAMACPP_PARALLEL`, `LLAMACPP_SLOT_SAVE_PATH`, `TRADINGVIEW_WEBHOOK_SECRET`
