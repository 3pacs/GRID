...
|---|---|---|
| `intelligence/` | 166 | 98,601 |
| `ingestion/` | 204 | 83,344 |
| `api/` | 105 | 47,667 |
| `analysis/` | 33 | 18,969 |
| `trading/` | 34 | 14,102 |
| `oracle/` | 29 | 10,539 |
...
**Docstring:** GRID [[Cross Reference|Cross-Reference]] Engine — Lie Detector for Government Statistics.
...
#### `intelligence/postmortem.py` — 2097 LOC
...
#### `ingestion/altdata/dark_pool.py` — 541 LOC
...
#### `ingestion/altdata/fed_liquidity.py` — 667 LOC
...
#### `ingestion/altdata/supply_chain.py` — 846 LOC
...
#### `ingestion/international/akshare_macro.py` — 304 LOC
...
#### `ingestion/international/bcb.py` — 151 LOC
...
#### `ingestion/international/mas.py` — 175 LOC
...
#### `ingestion/solana/top_volume.py` — 661 LOC
...
#### `ingestion/tiingo_pull.py` — 212 LOC
...
**Reads:** `__future__`, `analysis`, `api`, `asyncio`, `datetime`, `fastapi`, `inference`, `intelligence`, `loguru`, `numpy`, `ollama`, `pathlib`, `physics`, `re`, `sqlalchemy`, `typing`, `utils`
...
#### `api/routers/system.py` — 1694 LOC
...
#### `analysis/money_flow_engine/layer_sovereign.py` — 233 LOC
...
#### `trading/options_recommender.py` — 1636 LOC
...
**Reads:** `__future__`, `ast`, `dataclasses`, `datetime`, `enum`, `hashlib`, `intelligence`, `json`, `llm`, `loguru`, `numpy`, `oracle`, `os`, `sqlalchemy`, `typing`
...
#### `oracle/model_factory.py` — 331 LOC
**Docstring:** GRID Oracle — Model Factory.
**Functions:** `ModelSpec`, `ModelFactory`, `migrate_default_models`
**Reads:** `__future__`, `dataclasses`, `datetime`, `json`, `loguru`, `oracle`, `os`, `re`, `sqlalchemy`, `typing`
...
**Imported by:** `agents/runner.py`, `alerts/hundredx_digest.py`, `alerts/push_notify.py`, `alerts/scheduler.py`, `alerts/supply_chain_alerts.py`, `alerts/waterfall_watch.py`, `api/routers/associations.py`, `ingestion/realtime/flusher.py`, … (+5)
...
#### `discovery/clustering.py` — 624 LOC
**Docstring:** GRID cluster discovery engine.
**Functions:** `ClusterDiscovery`
**Reads:** `__future__`, `datetime`, `db`, `hyperspace`, `json`, `loguru`, `matplotlib`, `numpy`, `pandas`, `pathlib`, `scipy`, `sklearn`, `sqlalchemy`, `store`, `tempfile`, `typing`
