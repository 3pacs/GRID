...
**Imported by:** `intelligence/news_impact.py`, `oracle/contrast_distillation.py`, `oracle/forecaster_adapter.py`, `oracle/psi_model.py`, `store/astrogrid.py`
